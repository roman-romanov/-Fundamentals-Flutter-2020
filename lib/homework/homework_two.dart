          ...
          child: SingleChildScrollView(
            child: Stack(
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 254, left: 16),
                    ...
                    child: Row(
                      ...
                      Container(
                          ...
                          child: Icon(Icons.star,
                              color: Color.fromRGBO(255, 51, 101, 1),
                              size: 14)),
                      Container(
                ...
                Container(
                    ...
                    child: Text('Storyline',
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.w900))),
                Container(
                    margin: EdgeInsets.only(top: 430, left: 16),
                    child: Text(
                ...
                Container(
                    ...
                    child: Text('Cast',
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.w900))),
                Container(
                  margin: EdgeInsets.only(top: 585, left: 16),
                  child: Row(
                          ...
                          Container(
                              ...
                              child: DecoratedBox(
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                          image:
                                              Image.asset('assets/c_evans.png')
                                                  .image)))),
                          Container(
                              margin: EdgeInsets.only(top: 5, left: 0),
                              child: Text('Chris\nEvans',
